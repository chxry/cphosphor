SRC = $(shell find src/ lib/cglm/src/ -type f -name '*.c') lib/glad/glad.c lib/log/src/log.c lib/ini/src/ini.c
OBJS = $(SRC:.c=.o)
TARGET = out

CFLAGS = -Wall -O2 -c -DIMGUI_IMPL_API="extern \"C\"" -DLOG_USE_COLOR
CFLAGS += -Ilib -Ilib/log/src -Ilib/ini/src -Ilib/cimgui -Ilib/cimgui/imgui -Ilib/cglm/include -I/usr/include/SDL2
